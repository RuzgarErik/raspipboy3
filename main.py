...
class Engine:
	...
	def __init__(self, *args, **kwargs): 
		...
		scanline = pygame.transform.smoothscale (scanline, (int(config.WIDTH), int(lineHeight)))
		...
		distortLine = pygame.transform.smoothscale (distortLine, ( int(config.WIDTH), int(distortLineHeight) ))
